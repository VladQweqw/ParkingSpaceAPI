...
public class User {
    ...
    private Set<ParkingSpace> uploaded_parking_spaces = new HashSet<>();

    @OneToMany(mappedBy = "owner", cascade = CascadeType.ALL)
    @JsonIgnoreProperties("owner")
    private Set<Vehicle> vehicles_owned = new HashSet<>();
    ...
    public Set<ParkingSpace> getUploaded_parking_spaces() {
        return uploaded_parking_spaces;
    }

    public Set<Vehicle> getVehicles_owned() {
